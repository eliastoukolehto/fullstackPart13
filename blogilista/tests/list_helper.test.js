...
describe('favorite blog', () => {
  ...
  test('works with one blog', () => {
    ...
    const correct = { title: 'Go To Statement Considered Harmful', author: 'Edsger W. Dijkstra', likes: 5 }
    assert.deepStrictEqual(result, correct)
  })

  test('of a list is right', () => {
    const result = listHelper.favoriteBlog(listWithManyBlogs)
    const correct = { title: 'Canonical string reduction', author: 'Edsger W. Dijkstra', likes: 12 }
    assert.deepStrictEqual(result, correct)
  })
})
